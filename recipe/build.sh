...
make MOTIF_APS="" PARTS="mdsshr mdsdcl treeshr tdishr mdstcpip" MISC_PARTS="tdi include"
make install MOTIF_APS="" PARTS="mdsshr mdsdcl treeshr tdishr mdstcpip" MISC_PARTS="tdi include"
